      ...
      <div className={style.box} style={{ width: "60%" }}>
        ...
        <div className={style.upper} style={{ border: "3px solid black", height: "auto" }}>
          <div style={{ display: "flex", marginLeft: "30px" }}>
            <img
              ...
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTcGPvjFQlKlorhJqysJqO8O2BqT93AUdfTw&usqp=CAU"
              alt=""
            />{" "}
          ...
          >
            <img
              ...
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjwjVyCGNLyCNKUzARRlJBraMJqS1fKtWnHg&usqp=CAU"
              alt="shipmentlogo"
            />
            <p>
              Shipment 1: Standard Delivery{" "}
              <span style={{ marginLeft: "50px" }}> Delivery Charge: FREE</span>
            </p>
        ...
        >
          <img
            ...
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2p2nalhNNSXVnejos6BLISNvSRMnkRXaL7Q&usqp=CAU"
            alt="payment logo"
          />
          <span
